...
public class ConeCalculatorApp {
    ...
    public ConeCalculatorApp(){
        ...
        System.out.print("Sisesta jäätisekoonuse diameeter sentimeetrites: ");
        ...
        System.out.println("Sinu vahvelkoonuse pindala on " + formatter.format(cone.getArea())  + " ruutsentimeetrit");
